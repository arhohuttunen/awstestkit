...
dependencies {
    ...
    testImplementation("software.amazon.awssdk:cloudformation:2.25.40")
    testImplementation("software.amazon.awssdk:dynamodb:2.25.40")
    testImplementation("software.amazon.awssdk:s3:2.25.40")
