...
dependencies {
    ...
    testImplementation("software.amazon.awssdk:cloudformation:2.21.26")
    testImplementation("software.amazon.awssdk:dynamodb:2.21.26")
    testImplementation("software.amazon.awssdk:s3:2.21.26")
    testImplementation("software.amazon.awssdk:secretsmanager:2.21.26")
    testImplementation("software.amazon.awssdk:sns:2.21.26")
    testImplementation("software.amazon.awssdk:sqs:2.21.26")
}
