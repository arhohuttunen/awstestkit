...
dependencies {
    ...
    testImplementation("software.amazon.awssdk:cloudformation:2.30.16")
    testImplementation("software.amazon.awssdk:dynamodb:2.30.16")
    testImplementation("software.amazon.awssdk:s3:2.30.16")
    testImplementation("software.amazon.awssdk:secretsmanager:2.30.16")
    testImplementation("software.amazon.awssdk:sns:2.30.16")
    testImplementation("software.amazon.awssdk:sqs:2.30.16")
