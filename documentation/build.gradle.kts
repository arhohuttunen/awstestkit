...
dependencies {
    ...
    testImplementation("software.amazon.awssdk:cloudformation:2.28.16")
    testImplementation("software.amazon.awssdk:dynamodb:2.28.16")
    testImplementation("software.amazon.awssdk:s3:2.28.16")
    testImplementation("software.amazon.awssdk:secretsmanager:2.28.16")
    testImplementation("software.amazon.awssdk:sns:2.28.16")
    testImplementation("software.amazon.awssdk:sqs:2.28.16")
}
