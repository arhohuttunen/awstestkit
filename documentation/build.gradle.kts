...
dependencies {
    ...
    testImplementation("software.amazon.awssdk:cloudformation:2.24.5")
    testImplementation("software.amazon.awssdk:dynamodb:2.24.5")
    testImplementation("software.amazon.awssdk:s3:2.24.5")
    testImplementation("software.amazon.awssdk:secretsmanager:2.24.5")
    testImplementation("software.amazon.awssdk:sns:2.24.5")
    testImplementation("software.amazon.awssdk:sqs:2.24.5")
}
