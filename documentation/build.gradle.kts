...
dependencies {
    ...
    testImplementation("software.amazon.awssdk:cloudformation:2.26.29")
    testImplementation("software.amazon.awssdk:dynamodb:2.26.29")
    testImplementation("software.amazon.awssdk:s3:2.26.29")
    testImplementation("software.amazon.awssdk:secretsmanager:2.26.29")
    testImplementation("software.amazon.awssdk:sns:2.26.29")
    testImplementation("software.amazon.awssdk:sqs:2.26.29")
}
