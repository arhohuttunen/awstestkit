...
class LocalStackSqsExtension : BeforeAllCallback, AfterAllCallback, BeforeEachCallback, AfterEachCallback {
    ...
    private fun findAnnotation(annotatedElement: AnnotatedElement): Optional<LocalStackSqs> {
        return AnnotationUtils.findAnnotation(annotatedElement, LocalStackSqs::class.java)
    }
}